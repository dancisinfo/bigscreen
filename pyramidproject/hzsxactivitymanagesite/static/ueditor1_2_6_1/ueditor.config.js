...
(function () {
     ...
     */
    window.UMEDITOR_HOME_URL="/static/ueditor1_2_6_1/";
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,imagePath:"http://shikeim.qiniudn.com/"   //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ...
        //图片在线管理配置区
        ,imageManagerUrl:URL + "ueditor/imgmanage"       //图片在线管理的处理地址
        ,imageManagerPath:URL + "http://shikeim.qiniudn.com/"//图片修正地址，同imagePath
        ...
        , toolbars:[
            ...
            'insertorderedlist','insertunorderedlist','|','horizontal','insertimage','map','source']
        ]
...
//        }
        ...
        //     return {
        //         //直接删除及其字节点内容
        //         '-' : 'script style object iframe embed input select a',
        //         'a': {$:{}},
        //         'p': {$:{}},
        //         'br':{$:{}},
        //         'div':{'$':{}},
...
//                },
                ...
                table: function (node) {
                    ...
                    var val = '100%' ;//node.getAttr('width');
                    node.setAttr();
                    if (val) {
                        node.setAttr('width', val);
                        // node.setAttr('border','1px solid #aaa')
                    }
                },
                tbody: {$: {}},
                caption: {$: {}},
